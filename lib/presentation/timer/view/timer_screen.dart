...
class _TimerScreenState extends ConsumerState<TimerScreen> {
  ...
  Future<void> _initializeDefaultPresets() async {
    ...
    final defaultPresets = [
      TimerPresetEntity(
        ...
        durationMinutes: 7,
        durationSeconds: 0,
        description: AppLocalizations.of(context).timerPresetPastaCookingDesc,
        icon: 'pasta',
      ...
      TimerPresetEntity(
        ...
        durationMinutes: 8,
        durationSeconds: 0,
        description: AppLocalizations.of(context).timerPresetHardBoiledEggDesc,
        icon: 'egg',
        createdAt: DateTime.now(),
        isDefault: true,
      ),
      TimerPresetEntity(
        ...
        durationMinutes: 6,
        durationSeconds: 0,
        description: AppLocalizations.of(context).timerPresetSoftBoiledEggDesc,
        icon: 'egg',
        createdAt: DateTime.now(),
        isDefault: true,
      ),
      TimerPresetEntity(
        id: '4',
        name: AppLocalizations.of(context).timerPresetInstantNoodle,
        durationMinutes: 3,
        durationSeconds: 0,
        description: AppLocalizations.of(context).timerPresetInstantNoodleDesc,
        icon: 'noodles',
        createdAt: DateTime.now(),
        isDefault: true,
      ),
      TimerPresetEntity(
        ...
        durationMinutes: 3,
        durationSeconds: 0,
        description: AppLocalizations.of(context).timerPresetTeaBrewingDesc,
        icon: 'tea',
        createdAt: DateTime.now(),
        isDefault: true,
      ),
      TimerPresetEntity(
        id: '6',
        name: AppLocalizations.of(context).timerPresetSteakMedium,
        durationMinutes: 4,
        durationSeconds: 0,
        description: AppLocalizations.of(context).timerPresetSteakMediumDesc,
        icon: 'steak',
        createdAt: DateTime.now(),
        isDefault: true,
      ),
  ...
  Future<List<TimerPresetEntity>> _createHardcodedPresets() async {
    ...
    return [
      TimerPresetEntity(
        id: '1',
        name: AppLocalizations.of(context).timerPresetPastaCooking,
        durationMinutes: 7,
        durationSeconds: 0,
        description: AppLocalizations.of(context).timerPresetPastaCookingDesc,
        icon: 'pasta',
      ...
      TimerPresetEntity(
        id: '2',
        name: AppLocalizations.of(context).timerPresetHardBoiledEgg,
        durationMinutes: 8,
        durationSeconds: 0,
        description: AppLocalizations.of(context).timerPresetHardBoiledEggDesc,
        icon: 'egg',
      ...
      TimerPresetEntity(
        id: '3',
        name: AppLocalizations.of(context).timerPresetSoftBoiledEgg,
        durationMinutes: 6,
        durationSeconds: 0,
        description: AppLocalizations.of(context).timerPresetSoftBoiledEggDesc,
        icon: 'egg',
      ...
      TimerPresetEntity(
        id: '5',
        name: AppLocalizations.of(context).timerPresetTeaBrewing,
        durationMinutes: 3,
        durationSeconds: 0,
        description: AppLocalizations.of(context).timerPresetTeaBrewingDesc,
        icon: 'tea',
