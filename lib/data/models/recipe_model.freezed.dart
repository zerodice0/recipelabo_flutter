...
mixin _$RecipeModel {
 ...
 String get id; String get authorId; String get latestVersionId; String get name; String? get description; String? get sourceUrl; String? get sourceName; DateTime? get importedAt; bool get isPublic; DateTime get createdAt; DateTime get updatedAt; bool get isDeleted;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,authorId,latestVersionId,name,description,sourceUrl,sourceName,importedAt,isPublic,createdAt,updatedAt,isDeleted);

@override
String toString() {
  return 'RecipeModel(id: $id, authorId: $authorId, latestVersionId: $latestVersionId, name: $name, description: $description, sourceUrl: $sourceUrl, sourceName: $sourceName, importedAt: $importedAt, isPublic: $isPublic, createdAt: $createdAt, updatedAt: $updatedAt, isDeleted: $isDeleted)';
}
...
@useResult
$Res call({
 String id, String authorId, String latestVersionId, String name, String? description, String? sourceUrl, String? sourceName, DateTime? importedAt, bool isPublic, DateTime createdAt, DateTime updatedAt, bool isDeleted
});
...
/// Create a copy of RecipeModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? authorId = null,Object? latestVersionId = null,Object? name = null,Object? description = freezed,Object? sourceUrl = freezed,Object? sourceName = freezed,Object? importedAt = freezed,Object? isPublic = null,Object? createdAt = null,Object? updatedAt = null,Object? isDeleted = null,}) {
...
switch (_that) {
case _RecipeModel() when $default != null:
return $default(_that.id,_that.authorId,_that.latestVersionId,_that.name,_that.description,_that.sourceUrl,_that.sourceName,_that.importedAt,_that.isPublic,_that.createdAt,_that.updatedAt,_that.isDeleted);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String authorId,  String latestVersionId,  String name,  String? description,  String? sourceUrl,  String? sourceName,  DateTime? importedAt,  bool isPublic,  DateTime createdAt,  DateTime updatedAt,  bool isDeleted)  $default,) {final _that = this;
switch (_that) {
case _RecipeModel():
return $default(_that.id,_that.authorId,_that.latestVersionId,_that.name,_that.description,_that.sourceUrl,_that.sourceName,_that.importedAt,_that.isPublic,_that.createdAt,_that.updatedAt,_that.isDeleted);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String authorId,  String latestVersionId,  String name,  String? description,  String? sourceUrl,  String? sourceName,  DateTime? importedAt,  bool isPublic,  DateTime createdAt,  DateTime updatedAt,  bool isDeleted)?  $default,) {final _that = this;
switch (_that) {
case _RecipeModel() when $default != null:
return $default(_that.id,_that.authorId,_that.latestVersionId,_that.name,_that.description,_that.sourceUrl,_that.sourceName,_that.importedAt,_that.isPublic,_that.createdAt,_that.updatedAt,_that.isDeleted);case _:
  return null;
...
/// Create a copy of RecipeModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? authorId = null,Object? latestVersionId = null,Object? name = null,Object? description = freezed,Object? sourceUrl = freezed,Object? sourceName = freezed,Object? importedAt = freezed,Object? isPublic = null,Object? createdAt = null,Object? updatedAt = null,Object? isDeleted = null,}) {
