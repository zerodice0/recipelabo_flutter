...
abstract class $RecipeVersionModelCopyWith<$Res> {
  factory $RecipeVersionModelCopyWith(
          RecipeVersionModel value, $Res Function(RecipeVersionModel) then) =
...
abstract class _$$RecipeVersionModelImplCopyWith<$Res>
    implements $RecipeVersionModelCopyWith<$Res> {
  factory _$$RecipeVersionModelImplCopyWith(_$RecipeVersionModelImpl value,
...
class __$$RecipeVersionModelImplCopyWithImpl<$Res>
  ...
  __$$RecipeVersionModelImplCopyWithImpl(_$RecipeVersionModelImpl _value,
  ...
  $Res call({
    ...
    return _then(_$RecipeVersionModelImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
// 사용자 정의 버전명
  ...
  Map<String, dynamic> toJson() {
    return _$$RecipeVersionModelImplToJson(
      this,
    );
  }
}
...
abstract class _RecipeVersionModel implements RecipeVersionModel {
  const factory _RecipeVersionModel(
      ...
      final bool isDeleted,
      final String? changeLog,
      final String? baseVersionId}) = _$RecipeVersionModelImpl;
