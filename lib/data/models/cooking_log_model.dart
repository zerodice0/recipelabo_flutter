...
extension CookingLogModelExtension on CookingLogModel {
  Map<String, dynamic> toMap() {
    return {
      ...
      'saltinessRating': saltinessRating,
      'sweetnessRating': sweetnessRating,
      'spicinessRating': spicinessRating,
      'umamiRating': umamiRating,
  ...
  static CookingLogModel fromMap(Map<String, dynamic> map) {
    return CookingLogModel(
      ...
      saltinessRating: map['saltinessRating'] as int?,
      sweetnessRating: map['sweetnessRating'] as int?,
      spicinessRating: map['spicinessRating'] as int?,
      umamiRating: map['umamiRating'] as int?,
      failureReason: map['failureReason'] as String?,
      nextAdjustment: map['nextAdjustment'] as String?,
