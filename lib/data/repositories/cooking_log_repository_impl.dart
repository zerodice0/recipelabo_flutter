...
class CookingLogRepositoryImpl implements CookingLogRepository {
  ...
  CookingLogEntity _mapCookingLogModelToEntity(CookingLogModel model) {
    return CookingLogEntity(
      ...
      saltinessRating: model.saltinessRating,
      sweetnessRating: model.sweetnessRating,
      spicinessRating: model.spicinessRating,
      umamiRating: model.umamiRating,
      failureReason: model.failureReason,
      nextAdjustment: model.nextAdjustment,
  ...
  CookingLogModel _mapCookingLogEntityToModel(CookingLogEntity entity) {
    return CookingLogModel(
      ...
      saltinessRating: entity.saltinessRating,
      sweetnessRating: entity.sweetnessRating,
      spicinessRating: entity.spicinessRating,
      umamiRating: entity.umamiRating,
      failureReason: entity.failureReason,
      nextAdjustment: entity.nextAdjustment,
